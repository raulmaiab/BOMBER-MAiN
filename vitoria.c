...
bool ExecutarTelaVitoria(void)
{
    ...
    // CORREÇÃO: !WindowShouldClose() -> WindowShouldClose() == 0
    // O retorno deve ser 'true' SÓ SE o jogador pressionou ENTER (voltarAoMenu == true) E a janela não foi fechada.
